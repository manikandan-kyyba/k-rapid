...
We assume that you have already installed the mentioned libraries above, otherwise please check out the guides below.
 ...
 [K-Rapid - Getting Started](https://github.com/manikandan-kyyba/k-rapid/getting-started.html)
...
As you can see, we can already navigate between two screens. In the next steps, we will show you how to use K-Rapid's `AppBar` instead of the default header.
